...
@section('content')
<h2>Our Services</h2>
<div>Validate <a href="#" rel="nofollow">XHTML</a> &amp; 
    <a href="#" rel="nofollow">CSS</a>. Donec hendrerit. Maecenas nisl ante, mollis et, tincidunt vitae,   
    feugiat sit amet, mi. Vestibulum urna. Vivamus eu tortor. Phasellus   tempus, justo et laoreet varius, 
    odio mi ultrices libero, nec faucibus   dui felis eu dui. Cras ac odio ac mi imperdiet sollicitudin. In hac  
    habitasse platea dictumst. Curabitur euismod scelerisque lacus. Cras   pretium sem sed odio. 
    <a href="#">Vestibulum nisl mauris</a>, malesuada nec, dictum in,   molestie in, pede.</div>
<div><br />
</div>
<p>&nbsp;</p>
...
<div class="service_box">
    ...
    <div class="left">
        <img src="{{URL::to('public/images/chart1.png')}}" alt="image" />
    </div>
    <div class="right">
...
<div class="service_box">
    ...
    <div class="left">
        <img src="{{URL::to('public/images/chart2.png')}}" alt="image" />
    </div>
    <div class="right">
